    ...
    <section id="courses" className="py-24 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-[1600px] w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {filteredCourses.length === 0 ? (
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 ${filteredCourses.length === 1 ? 'lg:grid-cols-1 max-w-xl mx-auto' : filteredCourses.length === 2 ? 'lg:grid-cols-2 max-w-5xl mx-auto' : filteredCourses.length === 3 ? 'lg:grid-cols-3' : filteredCourses.length === 4 ? 'lg:grid-cols-4' : 'lg:grid-cols-4'} gap-6`}>
